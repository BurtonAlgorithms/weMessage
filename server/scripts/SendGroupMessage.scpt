on run {groupName, lastUpdated, lastMessage, fileLocation, message}
	...
	set returnSet to handlerLib's sendGroupMessage(groupName, lastUpdated, lastMessage, fileLocation, message)
