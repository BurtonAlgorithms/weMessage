on run {groupName, lastUpdated, lastMessage, iMessageAcc}
	...
	set returnSet to handlerLib's removeParticipantFromGroup(groupName, lastUpdated, lastMessage, iMessageAcc)
