...
public class CommandSendGroupMessage extends ScriptCommand {
    ...
    public void execute(String[] args){
        if (args.length < 2){
            ...
            ServerLogger.log("Example Usage: sendgroupessage \"Group Name\" \"An example Message.\" \"/Users/me/Desktop/example.file\"");
            ...
            ServerLogger.log("Example Usage: sendgroupmessage \"Group Name\" \"2:22 PM\" \"Last message sent\" \"Example message.\" \"/Users/me/Desktop/example.file\"");
            return;
        }
        String[] arguments = {};
        ...
        ServerLogger.log("Script SendGroupMessage returned a result of: " + processResult(result));
    }
}
